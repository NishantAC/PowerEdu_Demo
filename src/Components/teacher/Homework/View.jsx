            ...
            >
                <Box sx={style} className='mainbox'>
                    <div style={{ display: 'flex' }}>
                        <h3 className='head'>Uploaded Homework</h3>
                    ...
                    <>
                        <div style={{ width: '100%', padding: "20px" }}>
                            ...
                            <div style={{ width: '100%' }}>
                                ...
                                <textarea style={{ width: "100%" }} className='insidetext' disabled>{Tdata.homework_desc}</textarea>
                            </div>
                            <br />
                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                <div >
                                    ...
                                    <br />
                                    <input type='date' value={Tdata.homework_date} className='insidetext' disabled />
