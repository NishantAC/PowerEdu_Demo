...
import { registerClassTest } from "../../slices/classtest";
import { clearMessage } from "../../slices/message";

const RegisterClassTest = () => {
  ...
  const handleregisterclasstest = (formValue) => {

    const { school_id, classname, subjectname, syllabus, examdate, totalmarks, createdby } = formValue;

    setSuccessful(false);

    dispatch(registerClassTest({ school_id, classname, subjectname, syllabus, examdate, totalmarks, createdby }))
      .unwrap()
      .then(() => {
        setSuccessful(true);
      })
    ...
    <div className="col-md-12 signup-form">
      <div className="card card-container">
        <Formik
          ...
          onSubmit={handleregisterclasstest}
        >
          <Form>
          {/* <FormObserver /> */}
            {!successful && (
              <div>
                ...
                <div className="form-group">
                  <button type="submit" className="btn btn-primary btn-block">Register Class Test</button>
                </div>
              </div>
            )}
          </Form>
...
export default RegisterClassTest;