...
const RegisterSyllabus = () => {
  ...
  const handleRegisterSyllabus = (formValue) => {
    ...
    const { schoolcode, classname, subjectname, chaptername, status, createdby } = formValue;

    setSuccessful(false);

    dispatch(registersyllabus({ schoolcode, classname, subjectname, chaptername, status, createdby }))
      .unwrap()
      .then(() => {
        setSuccessful(true);
      })
