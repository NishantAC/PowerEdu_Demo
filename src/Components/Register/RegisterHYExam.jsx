...
import { registerhyexam } from "../../slices/hyexam";
import { clearMessage } from "../../slices/message";

const RegisterHYExam = () => {
  ...
  const handleregisterhyexam = (formValue) => {

    const { school_id, classname, subjectname, syllabus, examdate, totalmarks, createdby } = formValue;

    setSuccessful(false);

    dispatch(registerhyexam({ school_id, classname, subjectname, syllabus, examdate, totalmarks, createdby }))
      .unwrap()
      .then(() => {
        setSuccessful(true);
      })
          ...
          {/* <FormObserver /> */}
            {!successful && (
              <div>
                ...
                <div className="form-group">
                  <button type="submit" className="btn btn-primary btn-block">Register Half Yearly Exam</button>
                </div>
              </div>
            )}
          </Form>
