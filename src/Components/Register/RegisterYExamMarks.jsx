...
import { registeryexammark } from "../../slices/yexammark";
import { clearMessage } from "../../slices/message";

const RegisterYExamMark = () => {
  ...
  const handleregisteryexammark = (formValue) => {

    const { schoolcode, classname, subjectname, studentname, examdate, obtainedmarks, createdby } = formValue;

    setSuccessful(false);

    dispatch(registeryexammark({ schoolcode, classname, subjectname, studentname, examdate, obtainedmarks, createdby }))
      .unwrap()
      .then(() => {
        setSuccessful(true);
      })
    ...
    <div className="col-md-12 signup-form">
      <div className="card card-container">
        <Formik
          ...
          onSubmit={handleregisteryexammark}
        >
          <Form>
          {/* <FormObserver /> */}
            {!successful && (
              <div>
                ...
                <div className="form-group">
                  <button type="submit" className="btn btn-primary btn-block">Register Yearly Exam Marks</button>
                </div>
              </div>
            )}
          </Form>
...
export default RegisterYExamMark;