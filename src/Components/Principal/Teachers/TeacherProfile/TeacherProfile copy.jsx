...
function TeacherProfile() {
    ...
    return (
            ...
            <TableContainer component={Paper} style={{boxSizing: 'border-box',boxShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)',borderRadius: '5px', maxHeight: '370px', overflowY: 'auto' }}>
              <Table stickyHeader sx={{ minWidth: 200 }} aria-label="simple table" >
                    ...
                    {rows.map((row) => (
                        ...
                        <TableCell align="left" style={{paddingTop:'15px',paddingBottom:'15px', fontFamily: 'Lato', fontStyle: 'normal', fontWeight: '500', fontSize: '16px', color: '#000000'}}>{row.academicyear}</TableCell>
                        <TableCell align="left" style={{paddingTop:'15px',paddingBottom:'15px', fontFamily: 'Lato', fontStyle: 'normal', fontWeight: '500', fontSize: '16px', color: '#000000'}}>{row.studentclass}</TableCell>
                        <TableCell align="left" style={{paddingTop:'15px',paddingBottom:'15px', fontFamily: 'Lato', fontStyle: 'normal', fontWeight: '500', fontSize: '16px', color: '#000000'}}>{row.admissionNo}</TableCell>
                        <TableCell align="left" style={{paddingTop:'15px',paddingBottom:'15px', fontFamily: 'Lato', fontStyle: 'normal', fontWeight: '500', fontSize: '16px', color: '#000000'}}>{row.name}</TableCell>
                        <TableCell align="left" style={{paddingTop:'15px',paddingBottom:'15px', fontFamily: 'Lato', fontStyle: 'normal', fontWeight: '500', fontSize: '16px', color: '#000000',margin:'auto'}}>
                            <button type="submit" className="tchrviewoverallbtn" onClick={() => showOverall()}>View Overall</button>
                        </TableCell>
                        </TableRow>
                    ))}
                    </TableBody>
        ...
        <>
            ...
            <div style={{minWidth:'150px',width: "23%",height: "100%",textAlign: "left",padding: "5px 10px",alignItems: "center",backgroundColor: "#FFFFFF"}}>
                ...
                <div style={{textAlign:'center',marginTop:'50px'}}>
                    <Avatar className="stdntavtr" sx={{width:150, height:150}}><span>A</span></Avatar>
            ...
            <Box className="stdnttabs">
                ...
                <Tab label="Profile" {...a11yProps(0)} className="stdnttab1"/>
                <Tab label="Attendance" {...a11yProps(1)} className="stdnttab1"/>
                <Tab label="Feedback" {...a11yProps(2)} className="stdnttab1"/>
                </Tabs>
                ...
                <Button className="prncplprofilebackbtn" color='inherit' onClick={hideOverall} style={{marginTop:'20px', marginRight: '10px'}} ><KeyboardBackspaceOutlinedIcon style={{verticalAlign:'middle', marginRight: '2px'}}/>Back</Button>
            </Box>
