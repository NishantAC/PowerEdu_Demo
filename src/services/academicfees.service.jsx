...
const API_URL = API_BASE_URL+"academic-fees/";
...
const uniqueFrequencies = async (body) => {
  try {
    const response = await axios.post(`${API_URL}uniquefrequency`, body);
    return response.data;
  } catch (error) {
    console.error(error);
    throw error;
...
export default AcademicFeesService;
